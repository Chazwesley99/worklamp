...
export function Sidebar({ isOpen, onToggle, onClose }: SidebarProps) {
  ...
  // Check if the selected project has milestones enabled
  const hasMilestonesEnabled = selectedProject?.useMilestones || false;
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      showCondition: () => hasMilestonesEnabled,
    },
    {
      name: 'Tasks',
      href: '/tasks',
    ...
    {
      name: 'Files',
      href: selectedProject ? `/projects/${selectedProject.id}/files` : '/projects',
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
      ...
      showCondition: () => !!selectedProject,
    },
    {
      name: 'Env Variables',
      href: selectedProject ? `/projects/${selectedProject.id}/env-vars` : '/projects',
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-6 py-3">
            <Link href="/dashboard" onClick={onClose} className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-gray-100">Worklamp</span>
            </Link>
